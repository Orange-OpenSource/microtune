...
# VSBanditAgent: Vertical Scaling agent with N pkg arms
class VSAgent():
    ...
    # If wildcard is used somewhere in the filename (filever or dftext), the first matching file is loaded
...
from pkg.policy_sb3 import SB3Policy
