...
from pkg.reward import RewardDownStayUp
from pkg.perf_meter import PerfMeter
...
class VSMonitor(gym.Wrapper[ObsType, ActType, ObsType, ActType]):
    ...
    def save_regrets(self, algo_name = '', seed = 0, train_or_test = "train"):
        filename = f"/home/cloud/poc_fanfan/poc/auto-tuning/trainer/_app/pkg/diverse_graphics/lists_data/regret_per_episode_{algo_name}_{seed}_{train_or_test}.pkl"
        # Save the list to a file
        with open(filename, 'wb') as file:
            pickle.dump(self._regret_per_episode, file)
        filename = f"/home/cloud/poc_fanfan/poc/auto-tuning/trainer/_app/pkg/diverse_graphics/lists_data/iregret_per_episode_{algo_name}_{seed}_{train_or_test}.pkl"
        # Save the list to a file
        with open(filename, 'wb') as file:
            pickle.dump(self._iregret_per_episode, file)
        filename = f"/home/cloud/poc_fanfan/poc/auto-tuning/trainer/_app/pkg/diverse_graphics/lists_data/idelta_list_{algo_name}_{seed}_{train_or_test}.pkl"
        # Save the list to a file
        with open(filename, 'wb') as file:
